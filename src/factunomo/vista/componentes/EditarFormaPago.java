...
public class EditarFormaPago extends FormularioBase{
	  ...
	  */
	 public EditarFormaPago(JDialog principal, FormaPagoVO formaPago){
	 ...
	 private void creaVentana(){
		 // Nueva ventana
		 ventana = new JDialog(principal,"Editar Forma de pago",true);
		 ...
		 nombre.setText(formaPago.getNombre());
		 ...
		 ct.gridy++;
		 ct.gridwidth = 2;
		 cuenta.setSelected(formaPago.getNumeroCuenta());
	 ...
	 /**
	  * Devuelve el la forma de pago editada
	  * @return FormaPagoVO
	  */
