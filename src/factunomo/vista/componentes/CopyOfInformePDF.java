...
public class CopyOfInformePDF {
	 ...
	 */
	public CopyOfInformePDF(FiltroVO filtroInforme, Boolean informe1, Boolean informe2, Boolean informe3, Boolean informe4, Boolean informe5, Boolean informe6) {
		...
		try {
			...
			if (informe1)
			{
				...
				if (informe3)
				{
					...
					PdfPTable cabeceraIngresos = new PdfPTable(7);
					cabeceraIngresos.setWidths(new int[]{5,5,14,4,4,4,4});
					cabeceraIngresos.setWidthPercentage(100);
					...
					cell.setBackgroundColor(colorFondo);
					cabeceraIngresos.addCell(cell);
					ingresos.addCell(cabeceraIngresos);
					ingresos1 = new PdfPTable(7);
					ingresos1.setWidths(new int[]{5,5,14,4,4,4,4});
					ingresos1.setWidthPercentage(100);
				}
				...
				if (informe3)
				{
					ingresos.addCell(ingresos1);
					PdfPTable pieIngresos = new PdfPTable(7);
					pieIngresos.setWidths(new int[]{5,5,14,4,4,4,4});
					pieIngresos.setWidthPercentage(100);
			...
			if (informe2)
			{
				...
				if (informe3)
				{
					...
					PdfPTable cabeceraGastos = new PdfPTable(7);
					cabeceraGastos.setWidths(new int[]{5,5,14,4,4,4,4});
					cabeceraGastos.setWidthPercentage(100);
					...
					cell.setBackgroundColor(colorFondo);
					cabeceraGastos.addCell(cell);
					gastos.addCell(cabeceraGastos);
					gastos1 = new PdfPTable(7);
					gastos1.setWidths(new int[]{5,5,14,4,4,4,4});
					gastos1.setWidthPercentage(100);
				}
				...
				if (informe3)
				{
					gastos.addCell(gastos1);
					PdfPTable pieGastos = new PdfPTable(7);
					pieGastos.setWidths(new int[]{5,5,14,4,4,4,4});
					pieGastos.setWidthPercentage(100);
			...
			if (informe4)
			{
				...
				if (informe1)
				{
					cell = new PdfPCell(new Phrase("IVA Repercutido",
							FontFactory.getFont("arial",   // fuente
							10,                            // tamaño
							Font.NORMAL,                   // estilo
							BaseColor.BLACK)));             // color
				...
				if (informe2)
				{
					cell = new PdfPCell(new Phrase("IVA Soportado",
							FontFactory.getFont("arial",   // fuente
							10,                            // tamaño
							Font.NORMAL,                   // estilo
							BaseColor.BLACK)));             // color
