...
public class ModeloTablaIngresos implements TableModel {

	/**
	 * Lista con los datos. Cada elemento de la lista es una instancia de
	 * Gastos
	 */
	private ArrayList<IngresoVO> datos = new ArrayList<IngresoVO>();
	/**
	...
	public IngresoVO getIngreso(int rowIndex) {
		return (IngresoVO) (datos.get(rowIndex));
	}
	
	

	public Object getValueAt(int rowIndex, int columnIndex) {
		IngresoVO aux = (IngresoVO) (datos.get(rowIndex));
		switch (columnIndex) {
		case 0:
			return aux.getIdIngreso();
		case 1:
	...
	public void borraIngreso(int fila) {
	...
	public void addIngreso(IngresoVO nuevaIngreso) {
		this.datos.add(nuevaIngreso);
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		// Cambia el campo de Ingreso que indica columnIndex, poniendole el
		// aValue que se nos pasa.
		switch (columnIndex) {
		case 0:
			aux.setIdIngreso((String) aValue);
			break;
		case 1:
