...
public class ModeloTablaDetalleIngreso implements TableModel {

	/**
	 * Lista con los datos. Cada elemento de la lista es una instancia de
	 * DetalleGasto
	 */
	private ArrayList<DetalleIngresoVO> datos = new ArrayList<DetalleIngresoVO>();
	/**
	 ...
	 * @param tabla
	 */
	public ModeloTablaDetalleIngreso(JDialog ventana, JTable tabla){
	...
	public DetalleIngresoVO getDetalleIngreso(int rowIndex) {
		return (DetalleIngresoVO) (datos.get(rowIndex));
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		DetalleIngresoVO aux = (DetalleIngresoVO) (datos.get(rowIndex));
		switch (columnIndex) {
		case 1:
	...
	public void addDetalleIngreso(DetalleIngresoVO nuevoIngreso) {
	...
	public void borraTabla(){
		ArrayList<DetalleIngresoVO> vacio = new ArrayList<DetalleIngresoVO>();
		datos = vacio; 
	}
