...
public class ModeloTablaProveedor implements TableModel {
	 ...
	 * DetalleGasto
	 */
	private ArrayList<ProveedorVO> datos = new ArrayList<ProveedorVO>();
	/**
	 ...
	 * @param tabla
	 */
	public ModeloTablaProveedor(JDialog ventana, JTable tabla){
	...
	public ProveedorVO getProveedor(int rowIndex) {
		return (ProveedorVO) (datos.get(rowIndex));
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		ProveedorVO aux = (ProveedorVO) (datos.get(rowIndex));
		switch (columnIndex) {
		case 0:
	...
	public void addProveedor(ProveedorVO nuevoGasto) {
	...
	public void borraTabla(){
		ArrayList<ProveedorVO> vacio = new ArrayList<ProveedorVO>();
		datos = vacio; 
	}
